...
<html lang="en">
  ...
  <head>
    ...
    <title>Boojangles - - New York</title>
    <!-- Google font-->
                          ...
                          <table class="table table-bordernone">
                            <tbody>
                              ...
                              <tr>
                                ...
                                <td class="text-end">
                                  <div class="button btn btn-danger">Pending<i class="fa fa-check-circle ms-2"></i>
                                  </div>
                                </td>
                              </tr>
                            </tbody>
                    ...
                    <div class="card bg-img">
                      ...
                      <div class="card-body">
                        <div class="body-bottom">
                          ...
                          <span class="font-roboto">Lorem Ipsum is simply dummy...It is a long established fact that a
                            reader will be distracted by </span>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="chat">
                      <div class="media left-side-chat">
                        <div class="media-body d-flex">
                          <div class="img-profile"> <img class="img-fluid" src="{{asset('assets/images/user.jpg')}}"
                              alt="Profile"></div>
                          <div class="main-chat">
