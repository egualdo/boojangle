...
var options1 = {
  ...
  fill: {
    ...
    colors: [ BoojanglesAdminConfig.primary , BoojanglesAdminConfig.primary , BoojanglesAdminConfig.primary],
  },
  colors: [BoojanglesAdminConfig.primary, BoojanglesAdminConfig.secondary, BoojanglesAdminConfig.secondary],
};
...
var options2 = {
 ...
 colors: [ BoojanglesAdminConfig.primary , BoojanglesAdminConfig.primary , BoojanglesAdminConfig.primary , BoojanglesAdminConfig.primary ],
  plotOptions: {
    bar: {
      vertical: true,
      columnWidth: '40%',
  ...
  fill: {
    ...
    colors: [function({ value, seriesIndex, w }) {
      if(value < 0.75) {
          ...
          return BoojanglesAdminConfig.primary
      }
    }]
  }
};
