...
var barData = {
    ...
    datasets: [{
        ...
        strokeColor: BoojanglesAdminConfig.primary,
        highlightFill: "rgba(145, 46, 252, 0.6)",
        highlightStroke: BoojanglesAdminConfig.primary ,
        data: [35, 59, 80, 81, 56, 55, 40]
    }, {
        label: "My Second dataset",
        fillColor: "rgba(247, 49, 100, 0.4)",
        strokeColor: BoojanglesAdminConfig.secondary ,
        highlightFill: "rgba(247, 49, 100, 0.6)",
        highlightStroke: BoojanglesAdminConfig.secondary,
...
var polarData = [
    {
        ...
        highlight: BoojanglesAdminConfig.primary,
        label: "Yellow"
    }, {
        value: 50,
        color: "#f8d62b",
        ...
        value: 120,
        color: BoojanglesAdminConfig.secondary ,
        highlight: BoojanglesAdminConfig.secondary ,
        label: "Dark Grey"
    }
];
var polarOptions = {
...
var lineGraphData = {
    ...
    datasets: [{
        ...
        strokeColor: BoojanglesAdminConfig.primary ,
        pointColor: BoojanglesAdminConfig.primary ,
        ...
        strokeColor: BoojanglesAdminConfig.secondary ,
        pointColor: BoojanglesAdminConfig.secondary ,
        pointStrokeColor: "#fff",
        pointHighlightFill: "#000",
        pointHighlightStroke: BoojanglesAdminConfig.secondary,
        data: [28, 48, 40, 19, 86, 27, 90]
    }]
};
...
var radarData = {
    ...
    datasets: [{
        ...
        strokeColor: BoojanglesAdminConfig.primary,
        pointColor: BoojanglesAdminConfig.primary,
        pointStrokeColor: BoojanglesAdminConfig.primary,
        pointHighlightFill: BoojanglesAdminConfig.primary ,
