        ...
        function plotAccordingToChoices() {
            ...
            if (data.length > 0) {
                $.plot("#toggling-series-flot", data, {
                    ...
                    colors: [BoojanglesAdminConfig.primary, "#f8d62b" ,"#a927f9" ,"#51bb25" , BoojanglesAdminConfig.secondary , "#dc3545" ,"#f8d62b"]
...
$(function() {
    ...
    $.plot('#default-pie-flot-chart', data, {
        ...
        colors: [ BoojanglesAdminConfig.primary , "#51bb25" ,"#f8d62b" ,"#a927f9" ,"#dc3545", "#6c757d" , BoojanglesAdminConfig.secondary ]
    });
