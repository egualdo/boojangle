    ...
    var optionslinechart2 = {
        ...
        colors:[BoojanglesAdminConfig.secondary],
        series: [
            {
                name: 'series1',
...
var optionsuserchart = {
    ...
    colors:[BoojanglesAdminConfig.primary, BoojanglesAdminConfig.secondary, '#51bb25', '#544fff'],
    title: {
...
yaxis: {
    ...
    var optionsProgress1 = {
        ...
        fill: {
            ...
            type: 'gradient',
            gradient: {
                gradientToColors: [BoojanglesAdminConfig.primary]
            }
        },
        series: [{
            name: 'Process 1',
