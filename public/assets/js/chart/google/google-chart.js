...
function drawBasic() {
  if ($("#column-chart1").length > 0) {
      ...
      b = {
        ...
        height: 400,
        width:'100%',
          colors: [BoojanglesAdminConfig.primary, BoojanglesAdminConfig.secondary , "#51bb25"]
  ...
  if ($("#pie-chart1").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 300,
       colors: ["#f8d62b", "#51bb25" , "#a927f9"  , BoojanglesAdminConfig.secondary , BoojanglesAdminConfig.primary ]
      };
  ...
  if ($("#pie-chart2").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 300,
        colors: ["#f8d62b", "#a927f9" , "#51bb25", BoojanglesAdminConfig.secondary , BoojanglesAdminConfig.primary ]
      };
  ...
  if ($("#pie-chart4").length > 0) {
      ...
      var options = {
        ...
        slices: {  4: {offset: 0.2},
          ...
          colors: ["#dc3545", BoojanglesAdminConfig.primary , BoojanglesAdminConfig.secondary , "#51bb25", "#a927f9", "#f8d62b","#dc3545", BoojanglesAdminConfig.primary , "#f8d62b", "#51bb25", BoojanglesAdminConfig.primary , BoojanglesAdminConfig.secondary ,"#51bb25", BoojanglesAdminConfig.primary , "#a927f9", "#f8d62b", BoojanglesAdminConfig.primary , BoojanglesAdminConfig.primary, "#a927f9", BoojanglesAdminConfig.secondary , BoojanglesAdminConfig.primary , "#51bb25"]
        };
  ...
  if ($("#combo-chart").length > 0) {
      ...
      var options = {
        ...
        height: 500,
        width:'100%',
        colors: [BoojanglesAdminConfig.primary, BoojanglesAdminConfig.secondary , "#51bb25", "#a927f9", "#f8d62b"]
    };
  ...
  if ($("#area-chart1").length > 0) {
      ...
      var options = {
        ...
        width:'100%',
        height: 400,
        colors: [ BoojanglesAdminConfig.primary , BoojanglesAdminConfig.secondary ]
      };
  ...
  if ($("#area-chart2").length > 0) {
    ...
    var options = {
      ...
      width:'100%',
      height: 400,
      colors: [BoojanglesAdminConfig.primary , BoojanglesAdminConfig.secondary , "#51bb25", "#f8d62b"]
    };
    ...
    var options = {
        ...
        gantt: {
            ...
            arrow: {
                ...
                palette: [
                    {
                        "color": BoojanglesAdminConfig.primary,
                        "dark": BoojanglesAdminConfig.secondary ,
                        "light": "#047afb"
                    }
                ]
